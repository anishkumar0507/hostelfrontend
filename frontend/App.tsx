...
import WardenLocationTracking from './pages/warden/LocationTracking';
      ...
      <UIContext.Provider value={{ toast, showToast }}>
        <HashRouter>
          <Routes>
            ...
            <Route path="/warden/locations" element={<ProtectedRoute requiredRole={UserRole.WARDEN}><WardenLocationTracking /></ProtectedRoute>} />
