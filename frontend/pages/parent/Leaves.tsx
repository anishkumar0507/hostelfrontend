                ...
                {leave.status === 'PendingParent' && (
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white font-bold rounded-xl disabled:opacity-60 disabled:cursor-not-allowed"
                    >
                    ...
                    <button
                      ...
                      disabled={processingIds.has(leave.id)}
                      className="flex items-center gap-2 px-4 py-2 bg-red-500/30 hover:bg-red-500/50 text-red-200 font-bold rounded-xl disabled:opacity-60 disabled:cursor-not-allowed"
                    >
                      <X size={18} /> Reject
                    </button>
                  </div>
